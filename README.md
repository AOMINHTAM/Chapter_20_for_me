...
[![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=for-the-badge&logo=githubpages)](https://aominhtam.github.io/Chapter_20/)
[![Release](https://img.shields.io/badge/Release-v20.0-blue?style=for-the-badge&logo=git)](https://github.com/AOMINHTAM/Chapter_20)
...
Truy cập trực tiếp tại: **[https://aominhtam.github.io/Chapter_20/](https://aominhtam.github.io/Chapter_20/)**
...
* **Serverless Backend (Google Sheets Webhook):** Tích hợp Google Apps Script Webhook để lưu trữ thời gian thực (`Timestamp`, `Sender`, `Message`) vào Google Sheets mà không cần backend server phức tạp.
...
* **Data Pipeline / Storage:** Google Apps Script (`doPost`), Google Sheets API (Serverless Webhook via `FormData`).
...
```text
Chapter_20/
├── index.html          # Mã nguồn chính (UI Terminal, logic CLI & Webhook)
